/**
 * BankServiceServiceSoapBindingStub.java
 *
...
public class BankServiceServiceSoapBindingStub extends org.apache.axis.client.Stub implements beijing.bankservice.repository.BankService {
    ...
    public BankServiceServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public BankServiceServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public BankServiceServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = beijing.bankservice.exception.BankServiceException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {arg0});
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof beijing.bankservice.exception.BankServiceException) {
              throw (beijing.bankservice.exception.BankServiceException) axisFaultException.detail;
         }
   }
