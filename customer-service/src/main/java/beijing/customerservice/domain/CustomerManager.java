...
/**
 * 
 * CustomerManager cotains all the logic that allows us to manipulate with the
 * customer.
 * 
...
public class CustomerManager {
	...
	/**
	 * 
	 * Define a method that takes as input the customerRepository, making it easier
	 * to use further on.
	 * 
	 * @param _repository
	 * @throws IOException
	...
	/**
	 * 
	 * The MQs on the channels CUSTOMERID_TO_TOKENSERVICE_QUEUE,
	 * CUSTOMER_PAYMENT_REGITRATION and PAYMENT_CUSTOMER_REGITRATION are set. Thus,
	 * once creating a customer via REST we notify the TokenService that assigns
	 * tokens for the created customer.
	 * 
	 * @throws IOException
	 * @throws TimeoutException
	 * 
