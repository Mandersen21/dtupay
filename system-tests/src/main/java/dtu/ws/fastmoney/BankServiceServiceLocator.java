...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements dtu.ws.fastmoney.BankServiceService {
    ...
    private java.lang.String BankServicePort_address = "http://02267-kolkata.compute.dtu.dk:8080/BankService";
    ...
    public dtu.ws.fastmoney.BankService getBankServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            dtu.ws.fastmoney.BankServiceServiceSoapBindingStub _stub = new dtu.ws.fastmoney.BankServiceServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (dtu.ws.fastmoney.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                dtu.ws.fastmoney.BankServiceServiceSoapBindingStub _stub = new dtu.ws.fastmoney.BankServiceServiceSoapBindingStub(new java.net.URL(BankServicePort_address), this);
                _stub.setPortName(getBankServicePortWSDDServiceName());
                return _stub;
            }
        }
